 ...
 * @author Nathan Sweet
 */
public class MySkinLoader extends AsynchronousAssetLoader<MySkin, MySkinLoader.SkinParameter> {
    ...
    @Override
    public MySkin loadSync(AssetManager manager, String fileName, FileHandle file, SkinParameter parameter) {
     ...
     *         TextureAtlas.
     */
    protected MySkin newSkin(TextureAtlas atlas) {
	return new MySkin(atlas);
    }

    static public class SkinParameter extends AssetLoaderParameters<MySkin> {
